...
class LoginWithPassScreen extends StatefulWidget {
  const LoginWithPassScreen({super.key, required this.goToRegistration});
...
class _LoginWithPassScreenState extends State<LoginWithPassScreen> {
  ...
  void loginWithPass() async {
    try {
      ...
      LoginResponse response = await AuthService().loginWithPassword(
              ...
              child: Padding(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text(
                      "Bon retour parmi nous ,  ${user.lastName}",
